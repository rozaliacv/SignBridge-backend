...
def get_model(image_size, num_classes):
    ...
    model = models.Sequential([
        ...
        layers.Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l2(0.01)),  # Increased neurons
...
def train_model():
    ...
    callbacks = [
        EarlyStopping(monitor='val_accuracy', patience=5, restore_best_weights=True, min_delta=0.01),  # Increased patience
    ...
    print("Model saved as malayalam_sign_model_improved.h5")
